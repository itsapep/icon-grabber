...
$(document).ready(function(){
    ...
    Gimmie.$form.on('submit', function(e){
        ...
        if( Gimmie.userInputIsValid ) {
            ...
            .fail(function(data) {
                Gimmie.throwError(
                    'Apple Apps API Error',
                    'There was an error retrieving the info. Check the apps URL or try again later.'
                );
            });
        } else {
            Gimmie.throwError(
                'Invalid Link',
                'You must submit a standard Apple Apps store link with an ID, i.e. <br> <a href="https://apps.apple.com/us/app/twitter/id333903271?mt=8">https://apps.apple.com/us/app/twitter/<em>id333903271</em>?mt=8</a>'
            );
        }
    });
});